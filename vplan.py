...
class VSSProviderTest(testtypes.SystemTest):
    ...
    def exch_log_truncation(self, test_type):
        ...
        if test_type == 'win2012R2-exch2013':
            ...
            account_id = 'Administrator@exchange2019.com'
        else:
    ...
    @testtypes.stress_disable()
    @testtypes.suites('vss-provider-test')
    def test_exchange_log_truncation(self):
    ...
    def upgrade_dvx_software(self):
        ...
        while upgrade_status == False:
                txt = ''
                txt = ssh.check_output(carbon_mgmt_ip, 'dvx software show', username = 'admin', password = 'datrium#1')
                mat_obj = re.compile(r'(.|\n| )+DVX system upgraded')
                reg_obj = mat_obj.search(txt)
                if reg_obj is None:
